...
void sim(){
   ...
   //---- beam
   double KEAmean = 12; // MeV/u
   double KEAsigma = 0.1; // MeV/u , assume Guassian
   ...
   string stoppingPowerForA = "16N_in_CD2.txt"; // generated by SRIM
   string stoppingPowerForb = "3He_in_CD2.txt";
   string stoppingPowerForB = "15C_in_CD2.txt";
