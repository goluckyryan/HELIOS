...
// Fri Sep 21 12:40:16 2018 by ROOT version 6.12/06
// from TTree gen_tree/PSD Tree
// found on file: data/gen_run25.root
//////////////////////////////////////////////////////////
...
class Inspector : public TSelector {
public :
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Inspector(TTree * /*tree*/ =0) : fChain(0) { }
   virtual ~Inspector() { }
   ...
   ClassDef(Inspector,0);
};

#endif

#ifdef Inspector_cxx
void Inspector::Init(TTree *tree)
{
