...
/**///======================================================== Analysis
   ...
   */
   ...
   TCanvas * cCheck3 = new TCanvas("cCheck3", "cCheck3", 50, 500,  600, 300);
   cCheck3->SetGrid();
   tree->Draw("Ex >> hEx(400, -1, 4)"); 
   
   TCanvas * cCheck4 = new TCanvas("cCheck4", "cCheck4", 700, 50,  600, 400);
   cCheck4->SetGrid();
   tree->Draw("thetaCM:z >> htz(400, -500, -100, 400, 0, 45)"); 
   
   TCanvas * cCheck5 = new TCanvas("cCheck5", "cCheck5", 700, 500,  600, 400);
   cCheck5->SetGrid();
