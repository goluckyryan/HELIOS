...
void script(){
   ...
   TFile * file0 = new TFile("A_gen_run018.root");
   ...
   */
   ...
   TString gate_RDT = "e > 1 ";//"(cut0 || cut1 || cut2 || cut3) && -20 < coin_t && coin_t < 40 ";
   ...
   */
   ...
   tree0->Draw("Ex>>k(300, -1, 6)", gate_RDT, "");
   ...
   tree0->Draw("e:z >> h(400, -500,  -50, 400, 0, 10)", gate_RDT , "colz");
